        ...
        <td class="table-cell" onclick="event.stopPropagation()">
          <div class="flex space-x-3">
            ...
            ${
              contact.status === 'NEW'
                ? `
              <button class="action-btn btn-process" onclick="updateStatus('${contact.id}', 'PROCESSED')" title="Marquer comme traité" style="font-size: 1.125rem;">
                ✓
              </button>
            `
                : ''
            ...
            ${
              contact.status !== 'ARCHIVED'
                ? `
              <button class="action-btn btn-archive" onclick="updateStatus('${contact.id}', 'ARCHIVED')" title="Archiver" style="font-size: 1.125rem;">
                📦
              </button>
            `
                : ''
            }
            <button class="action-btn btn-delete" onclick="deleteContact('${contact.id}')" title="Supprimer définitivement" style="font-size: 1.125rem;">
              🗑
            </button>
          </div>
        </td>
